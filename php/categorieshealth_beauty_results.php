...
if ($listings === []) {
    echo '<div class="col-12"><div class="bg-white rounded p-3 text-center">No health or beauty-related listings are available right now.</div></div>';
    exit;
}
