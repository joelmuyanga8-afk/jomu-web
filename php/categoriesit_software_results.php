...
$categoryName = 'IT & Software Accessories';
$params = [$categoryName];
$types = 's';
...
if ($listings === []) {
    echo '<div class="col-12"><div class="bg-white rounded p-3 text-center">No IT or software-related listings are available right now.</div></div>';
    exit;
}
