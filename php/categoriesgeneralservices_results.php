...
$sql = "
    ...
    WHERE {$outOfStockFilter}{$moderationFilter} LOWER(TRIM(COALESCE(l.listing_type, ''))) = 'service'
...
if ($listings === []) {
    echo '<div class="col-12"><div class="bg-white rounded p-3 text-center">No service listings are available right now.</div></div>';
    exit;
}
